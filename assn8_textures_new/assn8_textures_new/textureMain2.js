...
function drawCurrentShape () {
    ...
    //
    gl.uniform1i (program.uGlobeTexture, 0);
    //
...
function initProgram (vertexid, fragmentid) {
  ...
  //
  program.uGlobeTexture = gl.getUniformLocation (program, 'uGlobeTexture');
  program.uMyImageTexture = gl.getUniformLocation (program, 'uMyImageTexture');
  program.uTextureMode = gl.getUniformLocation (program, 'uTextureMode');
